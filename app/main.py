...
@app.get("/api/companies/", status_code=status.HTTP_200_OK, response_model=List[schemas.CompanyResponse])
...
@app.get("/api/companies/{uuid_str}", status_code=status.HTTP_200_OK, response_model=schemas.CompanyResponse)
...
@app.post("/api/companies/", status_code=status.HTTP_201_CREATED, response_model=schemas.CompanyResponse)
...
@app.put("/api/companies/{uuid_str}", status_code = status.HTTP_200_OK, response_model = schemas.CompanyResponse)
